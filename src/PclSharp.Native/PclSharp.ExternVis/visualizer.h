...
EXPORT(void) visualizer_setPointCloudRenderingProperties_3x(visualizer* ptr, int property, double value1, double value2, double value3, const char* name, int viewport)
{
	ptr->setPointCloudRenderingProperties(property, value1, value2, value3, string(name), viewport);
}
