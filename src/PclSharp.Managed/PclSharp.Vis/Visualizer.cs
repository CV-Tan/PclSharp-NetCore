...
namespace PclSharp.Vis
{
    public static partial class Invoke
    {
        ...
        [DllImport(Native.DllName, CallingConvention = Native.CallingConvention)]
        public static extern void visualizer_setPointCloudRenderingProperties_3x(IntPtr ptr, int property, double value1, double value2, double value3, string name, int viewport);
    ...
    public class Visualizer : UnmanagedObject
    {
        ...
        public void SetPointCloudRenderingProperties(RenderingProperties property, double value1, double value2, double value3, string name = "cloud", int viewport = 0)
            => Invoke.visualizer_setPointCloudRenderingProperties_3x(_ptr, (int)property, value1, value2, value3, name, viewport);
